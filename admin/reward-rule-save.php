...
try {
    ...
    $result=tl_reward_management_save_rule($user,$raw);
    tl_security_session_start();
    $_SESSION['tl_reward_management_flash']=['tone'=>'success','message'=>!empty($result['created'])?'Reward rule created as a draft.':'Reward rule updated.'];
} catch(Throwable $e) {
