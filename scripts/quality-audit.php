...
$sections = [
    ...
    'api_runtime' => [
        ...
        'checks'=>[
            ...
            'guarded_processor_routes'=>$contains('api/training/reward-handoff-outbox.php', 'tl_stage893_process_handoff_guarded') && $contains('api/training/reward-handoff-operations.php', 'tl_stage893_process_guarded_batch'),
    ...
    'data_integrity' => [
        ...
        'checks'=>[
            ...
            'quarantine_excluded_from_retry'=>$contains('includes/training-lab-stage893-processing-wrapper.php', "failure_code<>'external_delivery_confirmation_required'"),
    ...
    'architecture_maintainability' => [
        ...
        'checks'=>[
            ...
            'isolated_reconciliation_service'=>$exists('includes/training-lab-stage893-external-delivery-reconciliation.php') && $exists('includes/training-lab-stage893-processing-wrapper.php') && $exists('includes/training-lab-stage893-worker-wrapper.php'),
    ...
    'deployment_operations' => [
        ...
        'checks'=>[
            ...
            'reconciliation_operator_panel'=>$contains('admin/reward-bridge.php', 'tl_stage893_render_admin_panel') && $contains('admin/action-result.php', 'stage893_reconcile_delivery_batch'),
