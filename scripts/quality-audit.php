...
$sections = [
    ...
    'deployment_operations' => [
        ...
        'checks'=>[
            ...
            'reconciliation_operator_panel'=>$contains('admin/reward-bridge.php', 'tl_stage893_render_admin_panel_guarded') && $contains('admin/action-result.php', 'stage893_reconcile_delivery_batch'),
