...
return [
    ...
    'training_lab' => [
        ...
        'notification_test_delivery_enabled' => false,
        'notification_provider' => 'resend',
        'notification_from_email' => '',
        'notification_from_name' => 'Microgifter Training Lab',
        ...
        'resend_connect_timeout_seconds' => 3,
        'resend_max_response_bytes' => 65536,
        'resend_webhook_enabled' => false,
        'resend_webhook_tolerance_seconds' => 300,
        'resend_webhook_max_body_bytes' => 262144,
        'limited_email_pilot_enabled' => false,
        'limited_email_pilot_processing_enabled' => false,
        'limited_email_pilot_maximum_cohort' => 10,
        'limited_email_pilot_maximum_batch' => 3,
        'limited_email_pilot_webhook_timeout_seconds' => 900,
        'limited_email_pilot_delay_timeout_seconds' => 1800,
        'limited_email_pilot_minimum_delivery_rate_percent' => 100,
        'limited_email_pilot_actor_user_id' => 1,
        ...
        // 'resend_api_key' => 'DO_NOT_COMMIT_A_REAL_SECRET',
